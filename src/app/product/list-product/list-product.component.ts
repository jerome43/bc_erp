...
export class ListProductComponent implements OnInit, OnDestroy {
  ...
  public displayedColumns: string[] = ['type', 'name', 'date', 'edit', 'delete', 'id']; // colones affichées par le tableau
  ...
  private initListProducts() {
    ...
    this.fbProductsSubscription = this.fbProducts.subscribe((products)=>{
      ...
      products.forEach((product)=>{
        ...
        this.productsData.push({id : product.id, type : type, name : product.name, date : product.date});
      });
